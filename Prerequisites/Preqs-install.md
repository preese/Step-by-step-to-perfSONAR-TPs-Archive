...
- If you're new to Linux or Cockpit, I suggest checking out the provided [links](PS-Archive-QuickStart/Additional-Resources/Cockpit-link.md).
...
(Review the [Network Setup](PS-Archive-QuickStart/Network-Details/Network-spec.md) page for needed details.)
...
3. Once cloned, [install the Testpoint package](PS-Archive-QuickStart/Build-TP-Archive-Grafana-systems/Install-Testpoint.md)
...
6. Install the [Archive and Grafana components](PS-Archive-QuickStart/Build-TP-Archive-Grafana-systems/Install-Archive-Grafana.md)
